...
<div class="row">
  <div class="col-md-12">
    ...
    <h1 class="page-subhead-line">Resumo geral de toda à aplicação</h1>
  ...
  <div class="col-md-4">
    <div class="main-box mb-pink">
      <a href="#">
        ...
        <?php
        $db = new medoo;
        $count = $db->count("th_administradores");
        ?>
        <h5><?php echo $count; ?></h5>
...
<div class="col-md-12">
  ...
  <?php
  $db = new medoo;
$se = $db->query("SELECT * FROM noticias ORDER BY visualizacao DESC");
  ?>
  var myData=[<?php
  foreach($se as $s)
      echo $s['visualizacao'].','; /* We use the concatenation operator '.' to add comma delimiters after each data value. */
  ?>];
