...
<head>
	...
	<script src="assets/js/jPages.js" type="text/javascript"></script>
...
<body>
			...
			<div class="row">
				<div class="col-md-4 ">
					<div class="navbar-header">
						...
						<a class="navbar-brand logo" href="#">Thiago Fernandes</a>
					</div>
				</div>
				<div class="col-md-8">
	...
	<div class="container-fluid work" id="work">
					...
					$(function() {
						$("div.paginacao").jPages({
							...
							callback    : function( pages,
								items ){
									$("#paginacao").html("Página " + pages.current + " de " + pages.count);
						...
						<?php
						$database = new medoo;
						$listar = $database->select("portfolio", "*", ["ativo" => 1, "ORDER" => "id DESC"]);

						echo "<div id='itemContainer'>";
						foreach ($listar as $list){

							$imagemOriginal = $list["imagem"];
							$pp = explode(".",$imagemOriginal);
							...
							<div class="col-md-4 col-sm-6 col-xs-12 work-space">
								<a href="<?php echo $list["url"]; ?>" target="_blank">
									<div class="featured-img">
										<img src="uploads/<?php echo $imagem ?>"/>
									</div>
		...
		<div class="container-fluid footer">
			<div class="row">
				<div class="col-md-12">
					<p>Copyright &copy; Ravalic 2015 By <a href="http://www.html5layouts.com">HTML5 Layouts</a></p>
				</div>
			</div>
		</div>
